        ...
        <div className={styles.main}>
            <div id='home' className={styles.home}>
                <div className={styles.profile}>
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Error eaque rem quibusdam nobis odit magni. Laudantium aspernatur eaque eligendi atque.</p>
                ...
                <div className={styles.image}>
                    <img className={styles.img} src={image} alt="Miguel Zuluaga" />
                </div>
            </div>
